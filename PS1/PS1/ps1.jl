...
opt_identity = Optim.optimize(vars -> Qfunction(vars, param, decision_meq, entrant_meq, X_meq, Z_meq, 100), ones(22), Optim.Options(show_trace = false, f_tol = 1e-7, g_tol = 1e-5))
